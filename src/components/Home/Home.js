          ...
          <Row>
            <Col md={7} className="home-header">
              ...
              <div className="main-page">
                <p>
                  with a passion for crafting digital solutions. I specialize in
                  turning ideas into elegant and efficient software, bringing
                  innovation to life one line of code at a time. Welcome to my
                  world of coding creativity.
                </p>
              </div>
